...
public class UT_MainService_Contracts
{
    ...
    public void TestInvokeAbiCommand_ContractNotFound()
    {
        ...
        Assert.Contains("Contract does not exist", output);
    }
    ...
    public void TestInvokeAbiCommand_MethodNotFound()
    {
        ...
        // Assert
        var output = _consoleOutput.ToString();
        Assert.Contains("Method 'nonExistentMethod' does not exist", output);
    }
    ...
    public void TestInvokeAbiCommand_WrongParameterCount()
    {
        ...
        // Assert
        var output = _consoleOutput.ToString();
        Assert.Contains("Method 'testBoolean' exists but expects 1 parameters, not 2", output);
    }
    ...
    public void TestInvokeAbiCommand_TooManyArguments()
    {
        ...
        // Assert
        var output = _consoleOutput.ToString();
        Assert.Contains("Method 'testMultipleParams' exists but expects 3 parameters, not 4", output);
    }
    ...
    public void TestInvokeAbiCommand_TooFewArguments()
    {
        ...
        // Assert
        var output = _consoleOutput.ToString();
        Assert.Contains("Method 'testMultipleParams' exists but expects 3 parameters, not 1", output);
    }
    ...
    public void TestInvokeAbiCommand_NoArgumentsForMethodExpectingParameters()
    {
        ...
        // Assert
        var output = _consoleOutput.ToString();
        Assert.Contains("Method 'testBoolean' exists but expects 1 parameters, not 0", output);
    }
    ...
    public void TestInvokeAbiCommand_InvalidParameterFormat()
    {
        ...
        // Assert
        var output = _consoleOutput.ToString();
        Assert.Contains("Failed to parse parameter 'value' (index 0)", output);
    }
    ...
    public void TestInvokeAbiCommand_ComplexTypes()
    {
        ...
        var output = _consoleOutput.ToString();
        Assert.DoesNotContain("Failed to parse parameter", output);
    }
    ...
    public void TestParseParameterFromAbi_ImprovedErrorMessages()
    {
        ...
        catch (TargetInvocationException ex)
        {
            ...
            Assert.Contains("Invalid integer format", ex.InnerException.Message);
        ...
        {
            Assert.IsInstanceOfType<ArgumentException>(ex.InnerException);
            Assert.Contains("Invalid Hash160 format", ex.InnerException.Message);
        ...
        {
            Assert.IsInstanceOfType<ArgumentException>(ex.InnerException);
            Assert.Contains("Invalid ByteArray format", ex.InnerException.Message);
    ...
    public void TestInvokeAbiCommand_MethodOverloading()
    {
        ...
        var output = _consoleOutput.ToString();
        Assert.DoesNotContain("Method 'transfer' exists but expects", output);
